...
from django.utils.encoding import str_text
...
class FormSubmissionAdmin(admin.ModelAdmin):
    ...
    def export_view(self, request, form_url=''):
        ...
        if form.is_valid():
            ...
            for submission in queryset:
                ...
                for field in submission.form_data:
                    ...
                    row[-4] = str_text(submission.created_by or _('Unknown'))
        ...
        context = {
            'title': _('Export %s') % str_text(self.opts.verbose_name_plural),
            'adminform': adminform,
